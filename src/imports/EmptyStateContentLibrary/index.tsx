import svgPaths from "./svg-zjclb3wvx2";
          ...
          <div className="content-stretch flex gap-[12px] items-center px-[12px] py-[10px] relative size-full">
            <div className="relative shrink-0 size-[16px]" data-name="Icons">
              <div className="-translate-x-1/2 absolute aspect-[40/40] bottom-0 left-1/2 top-0">
                <div className="absolute inset-[5.99%_6%]">
                  <svg className="block size-full" fill="none" height="14.0847" preserveAspectRatio="none" viewBox="0 0 14.08 14.0847" width="14.08">
                    <path d={svgPaths.p3f9fe000} id="Star 1" stroke="#4FCDFF" />
                  </svg>
                </div>
              </div>
              <div className="-translate-x-1/2 absolute aspect-[40/40] bottom-[3px] left-1/2 top-[3px]">
                <div className="absolute inset-[6.33%_6%]">
                  <svg className="block size-full" fill="none" height="8.73436" preserveAspectRatio="none" viewBox="0 0 8.8 8.73436" width="8.8">
                    <path d={svgPaths.p3229f700} id="Star 2" stroke="#4FCDFF" />
                  </svg>
                </div>
              </div>
...
function PageHeaderGrid() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Page Header Grid">
    ...
    <div className="bg-[#050507] relative rounded-[12px] shrink-0 w-full" data-name="Input_inner">
      <div className="flex flex-row items-center justify-end overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[4px] items-center justify-end p-[12px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[24px] min-w-px not-italic relative text-[#a1a1a1] text-[16px]">{`Search by content's name`}</p>
                ...
                <div className="flex-[1_0_0] h-full min-w-px relative" data-name="Vector">
                  <div className="absolute inset-[-4.17%]">
                    <svg className="block size-full" fill="none" height="26" preserveAspectRatio="none" viewBox="0 0 26 26" width="26">
                      <path d={svgPaths.p167bd740} id="Vector" stroke="#141414" strokeLinecap="round" strokeWidth="2" />
                    </svg>
                  </div>
                </div>
              </div>
  ...
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="sort-asc">
      <svg className="absolute block inset-0 size-full" fill="none" height="24" preserveAspectRatio="none" viewBox="0 0 24 24" width="24">
        <g id="sort-asc">
          <path d={svgPaths.p26f3280} id="Vector" stroke="#141414" strokeLinecap="round" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="content-stretch flex gap-[12px] items-start relative shrink-0" data-name="Toggle Buttons">
      <div className="bg-[rgba(10,10,13,0.6)] h-[50px] relative rounded-[6px] shrink-0" data-name="Expert toggle button">
        ...
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[12px] items-center px-[17px] py-[13px] relative size-full">
            <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#fdfdff] text-[0px] text-center whitespace-nowrap">
              <p className="leading-[24px] text-[16px]">Status: All</p>
            </div>
            <div className="relative shrink-0 size-[24px]" data-name="Icons">
      ...
      <div className="bg-[rgba(10,10,13,0.6)] h-[50px] relative rounded-[6px] shrink-0" data-name="Expert toggle button">
        ...
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[12px] items-center px-[17px] py-[13px] relative size-full">
            <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#fdfdff] text-[0px] text-center whitespace-nowrap">
              <p className="leading-[24px] text-[16px]">Sort: Last Modified</p>
            </div>
            <div className="relative shrink-0 size-[24px]" data-name="Icons">
              <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
...
function SearchToolbarBox() {
  return (
    <div className="bg-[#14141f] content-stretch flex gap-[12px] items-center p-[16px] relative rounded-[16px] shrink-0 w-full" data-name="Search Toolbar Box">
...
function IllustrationBoxHolder() {
  return (
    <div className="content-stretch flex h-[100px] items-center justify-center relative rounded-[8px] shrink-0 w-[160px]" data-name="Illustration Box Holder">
        ...
        <div className="-translate-x-1/2 absolute aspect-[40/40] bottom-0 left-1/2 top-0">
          <div className="absolute inset-[2.28%_6%]">
            <svg className="block size-full" fill="none" height="28.6319" preserveAspectRatio="none" viewBox="0 0 26.4 28.6319" width="26.4">
              <path d={svgPaths.p102c3600} id="Star 1" stroke="#4FCDFF" />
            </svg>
          </div>
        </div>
        <div className="-translate-x-1/2 absolute aspect-[40/40] bottom-[3px] left-1/2 top-[3px]">
          <div className="absolute inset-[2.85%_6%]">
            <svg className="block size-full" fill="none" height="22.6319" preserveAspectRatio="none" viewBox="0 0 21.12 22.6319" width="21.12">
              <path d={svgPaths.p54955f0} id="Star 2" stroke="#4FCDFF" />
            </svg>
          </div>
        </div>
        <div className="-translate-x-1/2 absolute aspect-[40/40] bottom-[6px] left-1/2 top-[6px]">
          <div className="absolute inset-[3.8%_6%]">
            <svg className="block size-full" fill="none" height="16.6319" preserveAspectRatio="none" viewBox="0 0 15.84 16.6319" width="15.84">
              <path d={svgPaths.p3f4e5800} id="Star 3" stroke="#4FCDFF" />
            </svg>
          </div>
        </div>
      </div>
...
function EmptyStateText() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-center not-italic relative shrink-0 text-center w-full" data-name="Empty State Text">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#fdfdff] text-[20px] whitespace-nowrap">No content yet</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#d0d0d0] text-[14px] w-[420px]">Upload your first media asset or create interactive content</p>
    </div>
  );
}

function EmptyContentCenterCard() {
  return (
    <div className="bg-[#14141f] content-stretch flex flex-[1_0_162px] flex-col gap-[24px] items-center justify-center min-h-px p-[80px] relative rounded-[16px] w-full" data-name="Empty Content Center Card">
      <div aria-hidden className="absolute border border-[rgba(67,67,67,0.13)] border-dashed inset-0 pointer-events-none rounded-[16px]" />
      <IllustrationBoxHolder />
      <EmptyStateText />
      <div className="bg-[#ff9b1d] relative rounded-[12px] shrink-0" data-name="Button">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex items-center px-[12px] py-[16px] relative size-full">
...
function ContentLibraryWorkspace() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-w-px pl-[24px] pr-[48px] py-[32px] relative self-stretch" data-name="Content Library Workspace">
      <PageHeaderGrid />
      <SearchToolbarBox />
      <EmptyContentCenterCard />
    </div>
  );
}

export default function EmptyStateContentLibrary() {
  return (
    <div className="bg-[#14141f] content-stretch flex items-start relative size-full" data-name="Empty State — Content Library">
